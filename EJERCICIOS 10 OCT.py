...
# Pruebas
print(validar_datos("Ana", "ana@email.com", 25, "secreto123"))  # True
print(validar_datos("", "no-email", 15, "123"))  # False
...
print("Filtro 1 (0-500):", [p["nombre"] for p in filtrar_productos(productos, 0, 500)])
print("Filtro 2 (100-1000, Electrónica):", [p["nombre"] for p in filtrar_productos(productos, 100, 1000, "Electrónica")])
...
# Prueba corregida
usuario = {"id": 1, "nombre": "Juan", "permisos": ["leer"]}
print(verificar_permisos(usuario, "leer"))  # True
print(verificar_permisos(usuario, "escribir"))  # False
...
print("Aprobados:", [e["nombre"] for e in aprobados])
